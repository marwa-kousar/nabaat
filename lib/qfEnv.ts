...
export const QF_USER_API_BASE =
  ...
  (QF_USE_PRELIVE ? 'https://prelive-apis.quran.foundation/auth/v1' : 'https://apis.quran.foundation/auth/v1');
...
export const QF_OAUTH_SCOPES = ['openid', 'offline_access', 'bookmark', 'user'] as const;
